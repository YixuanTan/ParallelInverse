...
public:
    ...
    void set_linear_temperature_on_sample_surface(double, double, std::vector<double>&);
...
void CopperSurfTemperatureDistribution::set_linear_temperature_on_sample_surface(double temperature_on_sample_left_end, double temperature_on_sample_right_end, std::vector<double>& x_coordinates){
    ...
    double temperature_of_current_node;
    
    for(int i=0; i<num_of_equations_on_sample_surface_; i++){
        temperature_of_current_node=(x_coordinates[first_node_on_sample_surface_+i]-left_node_x_coordinate)*slope+temperature_on_sample_left_end;
        temperature_on_sample_surface_.push_back(temperature_of_current_node);
    }
}
